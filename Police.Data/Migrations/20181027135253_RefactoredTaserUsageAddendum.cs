...
namespace Police.Data.Migrations {
    public partial class RefactoredTaserUsageAddendum : Migration {
        protected override void Up(MigrationBuilder migrationBuilder) {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table => {
                    table.PrimaryKey("PK_TaserUsageAddendums", x => new { x.IncidentId, x.OfficerId, x.SubjectId, x.ResponseId });
                    table.ForeignKey(
                        name: "FK_TaserUsageAddendums_Incidents_IncidentId",
                    ...
                    table.ForeignKey(
                        name: "FK_TaserUsageAddendums_Responses_IncidentId_OfficerId_SubjectId_ResponseId",
